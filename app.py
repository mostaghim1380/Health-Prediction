...
working_dir_heart = os.path.dirname(os.path.abspath('heart.pkl'))
working_dir_kidney = os.path.dirname(os.path.abspath('kindey.pkl'))
working_dir_diabetes = os.path.dirname(os.path.abspath('diabetes.pkl'))

heart_disease_model = pickle.load(open(f'{working_dir_heart}/heart.pkl','rb'))
kidney_disease_model = pickle.load(open(f'{working_dir_kidney}/kindey.pkl','rb'))
diabetes_model = pickle.load(open(f'{working_dir_diabetes}/diabetes.pkl','rb'))
